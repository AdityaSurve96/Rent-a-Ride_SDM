...
<div class="form">
 <div class="col-md-6"><label class="pull-right">Drivers License Number:</label></div>
 <div class="col-md-6"><input value = "${driverLicenseNumber}" class="pull-left" type="text" name="DrLicense" readonly>
 	 <input value = "${driverLicenseNumber}" type="hidden" name="DriversLicenseNoForForm">
 </div>
 </div>
 <br>
 <div class="form">
